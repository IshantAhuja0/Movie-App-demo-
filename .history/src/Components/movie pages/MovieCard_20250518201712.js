...
function MovieCard({data,key}) {
  return (
    <Card key={key} style={{ width: '16.3rem', height: "24.5rem" }} className='p-1 mx-2 d-flex flex-column'>
      <Card.Img variant="top" src={'https://image.tmdb.org/t/p/w1280' + data.poster_path} alt='Picture not available' style={{ height: '14.5rem' }} />
