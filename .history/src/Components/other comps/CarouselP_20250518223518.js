...
function CarouselP() {
  return (
    ...
    <Carousel style={{ margin:'0.5rem'}} interval={2000} className='bg-black mt-3'> 
      ...
      <Carousel.Item> 
       <img alt='' src='https://wallpaperaccess.com/full/37959.jpg' style={{height:'35rem' ,width:'91rem',maxHeight:'35rem',minHeight:'15rem'}} className='img-fluid h-auto' sm={6} md={4}  lg={3}/>
        <Carousel.Caption>
