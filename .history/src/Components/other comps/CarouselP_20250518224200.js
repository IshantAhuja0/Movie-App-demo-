...
{
  name:'Spiderman',
  src:'https://wallpaperaccess.com/full/914271.jpg'
},
{
  name:'Jawan',
  src:'https://i.ytimg.com/vi/UUrHQSqFrwg/maxresdefault.jpg'
},
{
  name:'Avengers',
  src:'https://th.bing.com/th/id/OIP.tbu3xV2WaJ74VuO8zxBYHgHaEK?w=1920&h=1080&rs=1&pid=ImgDetMain'
},
{
  name:'Joker',
  src:'https://wallpapercave.com/wp/wp7923275.jpg'
},
{
...

{
  items.map((data,id)=>{
      ...
      <Carousel.Item key={id}>
       <img src={data.src} style={{height:'35rem' ,width:'91rem',maxHeight:'35rem',minHeight:'15rem'}} className='img-fluid h-auto' sm={6} md={4}  lg={3}/>
        <Carousel.Caption>
          <h3>{data.name}</h3>
        </Carousel.Caption>
      </Carousel.Item>
